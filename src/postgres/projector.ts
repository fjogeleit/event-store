...
export class PostgresProjector<T extends State> implements Projector {
  private state?: T;
  ...
  when(handlers: { [p: string]: <T extends State>(state: T, event: IEvent) => T }): Projector {
